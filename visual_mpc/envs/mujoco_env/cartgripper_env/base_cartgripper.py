...
class BaseCartgripperEnv(BaseMujocoEnv):
    ...
    def _step(self, target_qpos, render):
        ...
        obs = self._get_obs(finger_force, render)
        self._post_step()
    ...
    def step(self, action, render=True):
        ...
        return self._step(target_qpos, render)
    ...
    def reset(self, reset_state=None):
        ...
        if reset_state is None:
            ...
            if 'qvel_all' in reset_state:
                qvel = reset_state['qvel_all']
            else: qvel =None
    ...
    def _get_obs(self, finger_sensors, render=True):
        obs, touch_offset = {}, 0
