...
class WidowXController(RobotController):
    def __init__(self, robot_name, print_debug, email_cred_file='', log_file='', control_rate=100, gripper_attached='default'):
        ...
        self._gripper_pub = rospy.Publisher('/gripper_joint/command', Float64, queue_size=1)
    ...
    def get_joint_angles(self):
        ...
        with self._joint_lock:
            joints_ret = ['joint_1', 'joint_2', 'joint_3', 'joint_4', 'joint_5', 'gripper_joint']
            try:
    ...
    def get_gripper_state(self, integrate_force=False):                         
        ...
        with self._joint_lock:
            joint_angle = self._angles['gripper_joint']
	joint_angle = joint_angle / GRIPPER_SCALE
