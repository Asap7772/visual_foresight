...
agent = {'type': GeneralAgent,
         ...
         'T': 8,  #number of commands per episodes (issued at control_rate / substeps HZ)
...
policy = {
    ...
    'log': True,
#'user': True,
#'path': '/home/stephen/offline_rl_models/bc/paramspy2.pkl',
#'path': '/home/stephen/offline_rl_models/lag20/paramspy2.pkl',
    "path": '/home/stephen/offline_rl_models/bc_aug/policy_py2.pkl',
...
config = {
    "experiment_name": "offline_tool_aug_bc_5_24",
    'traj_per_file':128,
    'save_data': True,
