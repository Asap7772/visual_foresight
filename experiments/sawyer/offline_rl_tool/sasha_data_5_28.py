...
from visual_mpc.policy.mfrl.policy_wrapper_cog import RLPolicyCOG
...
env_params = {
    'robot_name': 'galar',
    'camera_topics': [IMTopic('/front/image_raw', flip=False, left=34, right=80)],                  #, IMTopic('/bot/image_raw'), IMTopic('/bot2/image_raw')],
    'cleanup_rate': -1,
    'save_video': True,
...
#"path": '/home/stephen/offline_rl_models/auglag20/params_qfn_py2.pkl',
    #'path': '/home/stephen/eval_pickles_528/pt_drawer/pot_off_minq1.pt',
    #'path': '/nfs/kun1/users/asap7772/cog/data/tooluse-minq1/tooluse_minq1_2021_05_28_19_58_50_0000--s-0/model_pkl/120.pt',
    'path': '/nfs/kun1/users/asap7772/cog/data/tooluse-minq1/tooluse_minq1_2021_05_28_19_48_50_0000--s-0/model_pkl/120.pt',
