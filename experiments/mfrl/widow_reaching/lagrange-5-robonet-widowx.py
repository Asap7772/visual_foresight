...
policy = {
    ...
    'log': True,
    #'user': True,
    'path': '/root/ros_ws/anikait_home_models/lagrange-5-robonetwidowx-multiview/632/lagrange_5_robonetwidowx_multiview/632_2020_07_07_11_43_43_0000--s-0/params.pkl',
    'policy_type': 1,
    'goal_cond': True,
    'goals_path': '/root/ros_ws/anikait_home_models/widowx_full.hdf5',
    #'goal_pos': (0.935024, 0.204873, 0.0694792),
}

config = {
    "experiment_name": "lag_5_robonet_widowx",
    'traj_per_file':128,
    'save_data': True,
