...
policy = {
    ...
    'log': True,
    #'user': True,
    'path': '/root/ros_ws/src/brl_private_visual_foresight/models/data/lagrange-20-widowx-full/455434/lagrange_20_widowx_full/455434_2020_06_14_21_15_33_0000--s-0/params.pkl',
    'policy_type': 1,
    #'goal_pos': (0.935024, 0.204873, 0.0694792),
}

config = {
    "experiment_name": "lag_20_dense",
    'traj_per_file':128,
    'save_data': True,
