...
policy = {
    ...
    'log': True,
    #'user': False,
    'path': '/root/ros_ws/src/brl_private_visual_foresight/models/data/lagrange-5-widowx-full/610554/lagrange_5_widowx_full/610554_2020_06_14_21_15_19_0000--s-0/params.pkl',
    'policy_type': 1,
    #'goal_pos': (0.935024, 0.204873, 0.0694792),
}

config = {
    "experiment_name": "lag_5_dense",
    'traj_per_file':128,
    'save_data': True,
