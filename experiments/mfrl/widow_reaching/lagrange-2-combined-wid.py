...
policy = {
    ...
    'log': True,
    #'user': True,
    'path': '/root/ros_ws/src/brl_private_visual_foresight/models/data/lagrange-2-widowx-full/44397/lagrange_2_widowx_full/44397_2020_06_14_21_15_07_0000--s-0/params.pkl',
    'policy_type': 1,
    #'goal_pos': (0.935024, 0.204873, 0.0694792),
}

config = {
    "experiment_name": "lag_2_combined_wid",
    'traj_per_file':128,
    'save_data': True,
