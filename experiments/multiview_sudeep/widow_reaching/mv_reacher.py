...
from visual_mpc.policy.multiview_reaching.multiview_reach_policy import MultiViewReachPolicy
...
policy = {
    'type': MultiViewReachPolicy,
    'log': True,
    'goal_dir': '/root/ros_ws/src/brl_private_visual_foresight/experiments/multiview_sudeep/goals/goal_0/',
    'path': '/root/ros_ws/src/brl_private_visual_foresight/models/multiview/widowx_log/model_sd_60000.wgt',
    #'user': True,
    #'goal_pos': (0.935024, 0.204873, 0.0694792),
}

config = {
    "experiment_name": "mv_reacher",
    'traj_per_file':128,
    'save_data': True,
